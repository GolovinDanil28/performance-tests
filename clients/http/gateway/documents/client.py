...
class DocumentsGatewayHTTPClient(HTTPClient):
    ...
    def get_tariff_document_api(self, account_id: str) -> Response:
        ...
        return self.get(
            ...
            extensions=HTTPClientExtentions(route="/api/v1/documents/tariff-document/{account_id}")
        )
    ...
    def get_contract_document_api(self, account_id: str) -> Response:
        ...
        return self.get(
            ...
            extensions=HTTPClientExtentions(route="/api/v1/documents/contract-document/{account_id}")
        )
